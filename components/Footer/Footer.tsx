...
const Footer = () => {
  ...
  return (
    <div className='w-full bg-gray-50 space-y-8'>
      <div className="space-y-8 lg:flex p-4 lg:gap-10 xl:justify-between lg:px-20 lg:py-12 xl:px-40">
        <div className="flex flex-col gap-6 xl:gap-10">
          <Image
            ...
            className="w-[100px]"
          />
          <h1 className="text-wrap font-semibold text-2xl xl:text-4xl">Where stories come<br /> together.</h1>
        </div>
        <div className="space-y-8 lg:flex lg:gap-10 xl:gap-30 ">
          ...
          <div className="block sm:flex sm:gap-30 md:gap-50 lg:gap-10 xl:gap-30 space-y-8">
            <ul>
              <li className={commonClasses}>Pixory</li>
              {ulItems1.map((item) => (
                <li key={item} className="font-semibold pb-1 sm:pb-2">{item}</li>
              ))}
            </ul>
            <ul>
      ...
      <div className="pt-4 text-center border-t-2">@ 2025 Pixory</div>
    </div>
  );
}
